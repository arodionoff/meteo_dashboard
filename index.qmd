...
---
subtitle: "for **`r params$loc_name`** (`r round(params$loc_coordinats['latitude'], digi = 2)`° Lat, `r round(params$loc_coordinats['longitude'], digi = 2)`° Long) by"
---
...
## Row - <i class="bi bi-calendar-range"></i> Value boxes {height="15%"}
...
dur <- paste('Duration of observation', format(as.Date(params$Start_Date), '%B %Y'), '---', format(as.Date(params$Finish_Date), '%B %Y'))
...
### Column - Merge datasets {width="40%"}
...
# Map & Data {orientation="columns" scrolling="true"}

::: card
Здесь будет размещен набор данных
:::
